<template>
  <div class="context-manager">
    ...
    <el-dialog title="新增等级" :visible.sync="dialogFormVisible" width="40%">
      <el-form :model="form">
      ...
      methods: {
        ...
        submitDialog(flag) {
          ...
          if( flag ) {
            ...
            updateCatalog('/addLevel', param).then( res=> {
        ...
        handleDelete(obj) {
          obj.isUse = 0;
          updateCatalog('/addLevel', obj).then( res=> {
            dealResultWithoutData(res.data);
            this.getTableData();
          }).catch(function (error) {
            console.log(error);
